...
- URL: https://github.com/expellirmud-dot/agentic-framework-mcp.git
- github_repository_id: 1254538335
...
อ่าน `automation/state/agentic-framework-mcp.yaml` สำหรับ normalized state
