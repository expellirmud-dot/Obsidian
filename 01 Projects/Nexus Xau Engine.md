...
- URL: https://github.com/expellirmud-dot/nexus-xau-engine.git
- github_repository_id: 1353371152
...
อ่าน `automation/state/nexus-xau-engine.yaml` สำหรับ normalized state
