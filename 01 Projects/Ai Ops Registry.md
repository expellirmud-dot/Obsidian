...
- URL: https://github.com/expellirmud-dot/ai-ops-registry.git
- github_repository_id: 1256661628
...
อ่าน `automation/state/ai-ops-registry.yaml` สำหรับ normalized state
