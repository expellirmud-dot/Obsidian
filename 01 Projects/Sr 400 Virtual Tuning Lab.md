...
- URL: https://github.com/expellirmud-dot/SR-400-Virtual-Tuning-Lab.git
- github_repository_id: 1335719476
...
อ่าน `automation/state/SR-400-Virtual-Tuning-Lab.yaml` สำหรับ normalized state
