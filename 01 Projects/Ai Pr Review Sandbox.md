...
- URL: https://github.com/expellirmud-dot/ai-pr-review-sandbox.git
- github_repository_id: 1333989994
...
อ่าน `automation/state/ai-pr-review-sandbox.yaml` สำหรับ normalized state
