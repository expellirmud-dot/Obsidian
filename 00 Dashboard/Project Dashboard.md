...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Thai STT App | UNKNOWN | active | WO-Skill-Audit (skill audit + install for repository) | WO-Skill-Audit IN_PROGRESS — audit, fix, and install skills (project-read-first, windows-ui-review-runtime, impeccable, gridgeist) | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | 9db7818 | 9db7818 | 2026-09-15T01:05:40Z | Complete WO-Skill-Audit; then WO-OCR-09D (Real Thai OCR Provider, DRAFT) and WO-UI-08E (Final Compact Liquid Glass, DRAFT) | null |
...
| STT Typing | UNKNOWN | superseded-pending-roadmap | null | CURRENT WORK ORDER | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | 32e041e | 32e041e | 2026-09-16T01:04:52Z | Resolve blocker: STAGE_11_PRODUCTION_QT_ARCHITECTURE_INCOMPLETE | STAGE_11_PRODUCTION_QT_ARCHITECTURE_INCOMPLETE |
...
| Online Job Factory | Online Job Factory มีหน้าที่ช่วยค้นหา ประเมิน เตรียมสมัคร ผลิต ตรวจ และติดตาม... | null | null | null | UNKNOWN | unknown | FRESH | b6beac5 | b6beac5 | 2026-09-17T07:04:48Z | null | null |
