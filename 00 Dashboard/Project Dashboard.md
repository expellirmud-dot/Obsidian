...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Thai STT App | UNKNOWN | active | WO-Skill-Audit (skill audit + install for repository) | WO-Skill-Audit IN_PROGRESS — audit, fix, and install skills (project-read-first, windows-ui-review-runtime, impeccable, gridgeist) | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | 404cca9 | 404cca9 | 2026-08-22T13:03:26Z | Complete WO-Skill-Audit; then WO-OCR-09D (Real Thai OCR Provider, DRAFT) and WO-UI-08E (Final Compact Liquid Glass, DRAFT) | null |
...
| llm-agents | UNKNOWN | active | Wave 1 — Live provider test (1 bounded run, credential ready) | WO-03 G3 Clean Live Retest — DRAFTED, NOT EXECUTED (awaiting Owner Go) | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | d060ff2 | d060ff2 | 2026-08-20T07:05:35Z | Owner Go → Execute WO-03 live run (single invocation, strict gate) | Owner Go required — credential ready, single live run pending |
| STT Typing | UNKNOWN | superseded-pending-roadmap | null | CURRENT WORK ORDER | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | ef02946 | ef02946 | 2026-08-20T13:06:22Z | Resolve blocker: STAGE_11_PRODUCTION_QT_ARCHITECTURE_INCOMPLETE | STAGE_11_PRODUCTION_QT_ARCHITECTURE_INCOMPLETE |
...
| Rx 8 | UNKNOWN | null | null | CURRENT WORK ORDER | UNKNOWN | unknown | STALE — source HEAD changed after last semantic truth build | d942350 | d942350 | 2026-08-22T13:03:38Z | null | null |
